# Generated by Django 3.1.4 on 2025-09-06 18:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('forum', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('organisation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='leads.userprofile')),
            ],
        ),
        migrations.CreateModel(
            name='FollowUp',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('outside_allowed_hours', models.BooleanField(default=False)),
                ('agent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
